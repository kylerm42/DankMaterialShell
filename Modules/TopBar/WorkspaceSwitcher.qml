...
Rectangle {
    ...
    function getWorkspaceIcons(ws) {
        ...
        wins.forEach((w, i) => {
            ...
            if (!byApp[key]) {
                const icon = AppIconService.getAppIcon(keyBase);
                const nerdFontIcon = AppIconService.getNerdFontIcon(keyBase);
                byApp[key] = {
                    "type": "icon",
                    "icon": icon,
                    "nerdIcon": nerdFontIcon,
                        ...
                        delegate: Item {
                            ...
                            Item {
                                ...
                                IconImage {
                                    id: fallbackIcon
                                    anchors.fill: parent
                                    visible: !modelData.nerdIcon && modelData.icon
